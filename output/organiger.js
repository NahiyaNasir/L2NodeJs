...
const { off } = require('process');
   const sourceDir = path.join(process.cwd(), "output", "messy-files");
const organizedDir = path.join(process.cwd(), "output", "organized");
const categories = {
...
const testFiles = [
 ...
 function initializedDirectories(){
    ...
    testFiles.forEach((file)=>{
     fs.writeFileSync(path.join(sourceDir,file),`content os ${file}`)
    })
